UE.registerUI('kityformula', function(editor, uiname){
    ...
    var kfDialog = new UE.ui.Dialog({
        ...
        // 指定弹出层路径
        iframeUrl: bloghost+'zb_users/plugin/Huceo_formula/kityformula-plugin/kityFormulaDialog.html',
        // 编辑器实例
        editor: editor,
        // dialog 名称
        name: uiname,
    ...
    var iconUrl = bloghost+'zb_users/plugin/Huceo_formula/kityformula-plugin/kf-icon.png';
