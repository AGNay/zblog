...
if (count($_POST) > 0) {
  ...
  if (!$zbp->ValidToken(GetVars('token', 'POST'),'AppCentre')) {$zbp->ShowError(5, __FILE__, __LINE__);die();}
	...
	if (!GetVars('id')) {
		...
		if (property_exists($app2, 'isloaded')  && $app2->isloaded) {$zbp->ShowError('已存在同名的APP应用.');die();}
...
?>   />
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <label>
            <input type="checkbox" name="app_sidebars_sidebar6" value="1" <?php if ($app->sidebars_sidebar6) {
  echo 'checked="checked"';
}
?>   />
            侧栏6</label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <label>
            <input type="checkbox" name="app_sidebars_sidebar7" value="1" <?php if ($app->sidebars_sidebar7) {
  echo 'checked="checked"';
}
?>   />
            侧栏7</label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <label>
            <input type="checkbox" name="app_sidebars_sidebar8" value="1" <?php if ($app->sidebars_sidebar8) {
  echo 'checked="checked"';
}
?>   />
            侧栏8</label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <label>
            <input type="checkbox" name="app_sidebars_sidebar9" value="1" <?php if ($app->sidebars_sidebar9) {
  echo 'checked="checked"';
}
?>   />
            侧栏9</label>
