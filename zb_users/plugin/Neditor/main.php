...
if (0 == $editor_config['toolbar']) {
    $toolbar_img = $bloghost . 'zb_users/plugin/Neditor/images/default.png';
} else {
    $toolbar_img = $bloghost . 'zb_users/plugin/Neditor/images/full.png';
}
?>
...
#customtoolbar_full {
    display: <?php echo 2 == $editor_config['toolbar'] ? 'inline-block' : 'none'; ?>;
}
#toolbar_img {
    width: 1200px;
    height: auto;
    display: <?php echo 2 == $editor_config['toolbar'] ? 'none' : 'inline-block'; ?>;
}
#emotionUrlItem {
    display: <?php echo $plugin_config['emotion'] ? 'block' : 'none'; ?>
}
#addCsp {
        ...
        <div class="layui-tab-content">
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block" style="margin-left:0">
                                    <input lay-filter="toolbar" type="radio" name="toolbar" value="0" title="精简版"
                                        <?php echo 0 == $editor_config['toolbar'] ? 'checked' : ''; ?>>
                                    <input lay-filter="toolbar" type="radio" name="toolbar" value="1" title="完整版"
                                        <?php echo 1 == $editor_config['toolbar'] ? 'checked' : ''; ?>>
                                    <input lay-filter="toolbar" type="radio" name="toolbar" value="2" title="自定义"
                                        <?php echo 2 == $editor_config['toolbar'] ? 'checked' : ''; ?>>
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                <div class="layui-input-block" style="margin-left:0">
                                    <textarea id="customtoolbar_text" name="customtoolbar" placeholder="请输入工具栏布局代码" class="layui-textarea"><?php echo trim($editor_config['customtoolbar']); ?></textarea>
                                    <div class="layui-btn layui-btn-sm" id="customtoolbar_default">精简版布局代码</div>
                                    <div class="layui-btn layui-btn-sm" id="customtoolbar_full">完整版布局代码</div>
                                    <img src="<?php echo $toolbar_img;?>" id="toolbar_img">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="layui-field-box">
                                ...
                                <div class="layui-input-inline">
                                    <select id="fontfamily" name="fontfamily">
                                        ...
                                        <option value="宋体,SimSun" style="font-family:宋体,SimSun"
                                            <?php echo ('宋体,SimSun' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>宋体</option>
                                        <option value="微软雅黑,Microsoft YaHei" style="font-family:微软雅黑,Microsoft YaHei"
                                            <?php echo ('微软雅黑,Microsoft YaHei' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>微软雅黑
                                        </option>
                                        <option value="楷体,SimKai" style="font-family:楷体,SimKai"
                                            <?php echo ('楷体,SimKai"' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>楷体</option>
                                        <option value="黑体,SimHei" style="font-family:黑体,SimHei"
                                            <?php echo ('黑体,SimHei' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>黑体</option>
                                        <option value="隶书,SimLi" style="font-family:隶书,SimLi"
                                            <?php echo ('隶书,SimLi' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>隶书</option>
                                        <option value="andale mono" style="font-family:andale mono"
                                            <?php echo ('andale mono' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>Andale Mono</option>
                                        <option value="arial" style="font-family:arial, helvetica,sans-serif"
                                            <?php echo ('arial' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>Arial</option>
                                        <option value="arial black" style="font-family:arial black,avant garde"
                                            <?php echo ('arial black' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>Arial Black </option>
                                        <option value="comic sans ms" style="font-family:comic sans ms"
                                            <?php echo ('comic sans ms' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>Comic Sans MS</option>
                                        <option value="impact,chicago" style="font-family:impact,chicago"
                                            <?php echo ('impact,chicago' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>Impacl</option>
                                        <option value="times new roman" style="font-family:times new roman"
                                            <?php echo ('times new roman' == $editor_config['fontfamily']) ? 'selected="selected"' : ''; ?>>Times New Roman</option>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="fontsize" name="fontsize">
                                        ...
                                        <option value="12px" style="font-size:12px"
                                            <?php echo ('12px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>12px</option>
                                        <option value="14px" style="font-size:14px"<?php echo ('14px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>14px</option>
                                        <option value="16px" style="font-size:16px"<?php echo ('16px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>16px</option>
                                        <option value="18px" style="font-size:18px"<?php echo ('18px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>18px</option>
                                        <option value="20px" style="font-size:20px"<?php echo ('20px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>20px</option>
                                        <option value="24px" style="font-size:24px"<?php echo ('24px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>24px</option>
                                        <option value="36px" style="font-size:36px"<?php echo ('36px' == $editor_config['fontsize']) ? 'selected="selected"' : ''; ?>>36px</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="margin-left:15px">
                                    <textarea name="initstyle" placeholder="自定义编辑区域样式表，可以留空" rows="5" class="layui-textarea"><?php echo $editor_config['initstyle'];?></textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="number" min="1" step="1" name="listfilecount"
                                        ...
                                        value="<?php echo $editor_config['listfilecount']; ?>">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="divtop" name="divtop">
                                        ...
                                        <option value="0"
                                            <?php echo !$editor_config['divtop'] ? 'selected="selected"' : ''; ?>>关闭
                                        </option>
                                        <option value="1"
                                            <?php echo $editor_config['divtop'] ? 'selected="selected"' : ''; ?>>启用
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width:100px">
                                    <input type="number" min="1" step="1" name="autosave"
                                        placeholder="" autocomplete="off" style="width:100px" class="layui-input"
                                        value="<?php echo $editor_config['autosave']; ?>">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width:100px">
                                    <input type="number" min="1" step="1" name="zindex"
                                        placeholder="" autocomplete="off" style="width:100px" class="layui-input"
                                        value="<?php echo $editor_config['zindex']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="xss" name="xss">
                                        <option value="">请选择</option>
                                        <option value="0"
                                            <?php echo !$editor_config['xss'] ? 'selected="selected"' : ''; ?>>关闭
                                        </option>
                                        <option value="1"
                                            <?php echo $editor_config['xss'] ? 'selected="selected"' : ''; ?>>启用
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="intro" name="intro">
                                        <option value="">请选择</option>
                                        <option value="0"
                                            <?php echo !$editor_config['intro'] ? 'selected="selected"' : ''; ?>>关闭
                                        </option>
                                        <option value="1"
                                            <?php echo $editor_config['intro'] ? 'selected="selected"' : ''; ?>>启用
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="catchimg" name="catchimg">
                                        <option value="">请选择</option>
                                        <option value="0"
                                            <?php echo !$editor_config['catchimg'] ? 'selected="selected"' : ''; ?>>关闭
                                        </option>
                                        <option value="1"
                                            <?php echo $editor_config['catchimg'] ? 'selected="selected"' : ''; ?>>启用
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="heightlight" name="heightlight">
                                        <option value="">请选择</option>
                                        <option value="1" <?php echo $plugin_config['heightlight'] ? 'selected="selected"' : ''; ?>>启用
                                        </option>
                                        <option value="0" <?php echo !$plugin_config['heightlight'] ? 'selected="selected"' : ''; ?>>关闭
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select name="emotion" lay-filter="emotion">
                                        <option value="">请选择</option>
                                        <option value="0" <?php echo !$plugin_config['emotion'] ? 'selected="selected"' : ''; ?>>本地
                                        </option>
                                        <option value="1" <?php echo $plugin_config['emotion'] ? 'selected="selected"' : ''; ?>>远程
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item" id="emotionUrlItem">
                                ...
                                <div class="layui-input-inline" style="width: 300px;">
                                    <input type="text" name="emotionurl"
                                        ...
                                        value="<?php echo $plugin_config['emotionurl']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <select id="keepconfig" name="keepconfig">
                                        <option value="">请选择</option>
                                        <option value="1" <?php echo $plugin_config['keepconfig'] ? 'selected="selected"' : ''; ?>>是
                                        </option>
                                        <option value="0" <?php echo !$plugin_config['keepconfig'] ? 'selected="selected"' : ''; ?>>否
                                        </option>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="layui-tab-item">
                <div class="about">
                    ...
                    <p>Neditor v<?php $app=new App;$app->LoadInfoByXml('plugin', 'Neditor');echo $app->version; ?></p>
                    <br>
                    <br>
                    <p>插件作者：心扬</p>
                    <p>Logo设计：Argis沫</p>
                    ...
                    <br>
                    <br>
                    <div class="layui-btn layui-btn-sm" id="neditor-debug-btn">调试信息</div>
                </div>
                <fieldset class="layui-elem-field" id="neditor-debug-info" style="display:none">
                    ...
                    <div class="layui-field-box">
                        ...
                        <?php echo $zbp->cache->system_environment .
                            ...
                            'M<br>editor_config: ' . $zbp->Config('Neditor')->editor .
                            '<br>plugin_config: ' . $zbp->Config('Neditor')->plugin;
                        ?>
                        <hr class="layui-bg-blue">
...
// Neditor 后台全局统一变量
var NEDITOR_ADMIN = {
    HOME_URL: "<?php echo $zbp->host; ?>zb_users/plugin/Neditor",
    CSRF_TOKEN: "<?php echo $zbp->GetCSRFToken('Neditor'); ?>",
    EDITOR_CONFIG: <?php echo $zbp->Config('Neditor')->editor; ?>,
    PLUGIN_CONFIG: <?php echo $zbp->Config('Neditor')->plugin; ?>
};
</script>
