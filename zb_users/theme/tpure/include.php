...
{
    if(($template->GetTags('type') == 'index' && $template->GetTags('page') != '1') || $template->GetTags('type') == 'category' || $template->GetTags('type') == 'tag' || $template->GetTags('type') == 'author' || $template->GetTags('type') == 'date' ){
