...
<dl>
	<form method="post" class="setting">
        ...
        echo $zbp->host . 'zb_users/theme/tpure/style/images/logo.png';
						...
						<td><br>是否启用 <input type="text" id="PostLOGOON" name="PostLOGOON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostLOGOON; ?>" /><br><hr>启用动效 <input type="text" id="PostLOGOHOVERON" name="PostLOGOHOVERON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostLOGOHOVERON; ?>" /><br><br></td>
					</tr>
				</tbody>
			</table>
        ...
        echo $zbp->host . 'zb_users/theme/tpure/style/images/thumb.png';
						...
						<td><input type="button" class="uploadimg" value="上传"></td>
						<td><br>无图默认 <input type="text" id="PostTHUMBON" name="PostTHUMBON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostTHUMBON; ?>" /><br>有则展示 <input type="text" id="PostIMGON" name="PostIMGON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostIMGON; ?>" /><br><br></td>
					</tr>
				</tbody>
			</table>
			<i class="help"></i><span class="helpcon">使用默认缩略图，需开启“无图默认”开关。<br>仅显示文章缩略图，请开启“有则展示”开关。<br>如不需要任何缩略图，请关闭“有则展示”开关。</span>
		</dd>
		<dd>
